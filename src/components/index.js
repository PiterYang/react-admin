...
import TestEdit from './pages/test/test_edit/Main'
import User from './pages/user_manage/Index'
import UserEdit from './pages/user_manage/UserEditIndex'
...
export default {
    ...
    Cssmodule, MapUi, QueryParams, Test, TestEdit, User, UserEdit
}