...
import DynamicForm, { defaultLabelColSpan } from '../../forms/dynamic_form/DynamicForm'
    ...
    componentDidMount() {
        setTimeout(() => {
            const data = {
                ...
                RangePicker: ['2018-04-15T13:36:27.132Z', '2018-05-15T13:36:27.132Z'].map(v => moment(v)),
                Switch: true,
              }
